  ...
  if (projects.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-muted-foreground mb-2">아직 프로젝트가 없습니다</h3>
        <p className="text-muted-foreground text-sm">곧 멋진 프로젝트들을 선보일 예정입니다!</p>
      </div>
    )
  }
    ...
    <div className="w-full">
      ...
      <div className="text-center mt-8">
        <p className="text-sm text-muted-foreground">
          총 <span className="font-medium text-foreground">{projects.length}개</span>의 프로젝트
        </p>
      </div>
    </div>
  )
